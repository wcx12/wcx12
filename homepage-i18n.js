const profileUrl = new URL('./profile-data.js', import.meta.url);
profileUrl.search = new URL(import.meta.url).search;
const { profileData } = await import(profileUrl.href);

export const homepageI18n = {
  en: {
    skip_main: 'Skip to main content',
    selected_work: 'Selected work',
    selected_project: 'Engineering prototype',
    selected_project_desc: 'College-major research through SQL-backed agent tools. Public code and traces; core database remains private.',
    selected_paper: 'Paper',
    selected_paper_desc: 'Recognizing places with frozen foundation models, without task-specific fine-tuning. Method, benchmark results, and official code.',
    selected_note: 'Reading notes',
    selected_note_title: 'TIGER & Semantic IDs',
    selected_note_desc: 'From residual quantization to generative recommendation.',
    theme_neon: 'Default',
    theme_warm: 'Warm',
    theme_mono: 'Black & White',
    aria_theme: 'Color theme',
    aria_primary_navigation: 'Primary navigation',
    aria_home: 'wcx12 Home',
    ...
    stat_location: 'Based in',
    stat_location_value: 'Shenzhen',
    enhancement_pending: 'Loading interactive tools.',
    enhancement_error: 'Interactive tools could not load. The portfolio pages remain available.',
    enhancement_reload: 'Reload page',
    tools_title: 'Explore the work',
    stat_pubs: 'Publications',
    tab_about: 'overview',
    tab_research: 'Topic explorer',
    tab_projects: 'Repository browser',
    tab_publications: 'Paper browser',
    tab_writing: 'Reading list',
    tab_profile: 'At a glance',
    about_title: 'About',
    about_line1: profileData.about.en,
    ...
    profile_view_desc: 'Research, educational technology, and open-source work.',
    research_title: 'Research',
    research_static: 'Research overview',
    research_intro: 'Geometry, visual intelligence, and AI systems.',
    ...
    project_desc: 'Research software, prototypes, and teaching tools.',
    ...
    pub_desc: 'Peer-reviewed work in visual recognition and medical imaging.',
    ...
    writing_desc: 'Research notes and engineering practice.',
  ...
  zh: {
    skip_main: '跳到主要内容',
    selected_work: '代表工作',
    selected_project: '工程原型',
    selected_project_desc: '通过 SQL 工具与 Agent 检索院校专业信息。代码和运行轨迹公开，核心数据库未公开。',
    selected_paper: '论文',
    selected_paper_desc: '利用冻结的基础模型识别地点，无需任务微调。包含方法、基准实验结果与官方代码。',
    selected_note: '阅读笔记',
    selected_note_title: 'TIGER 与语义 ID',
    selected_note_desc: '从残差量化到生成式推荐。',
    theme_neon: '默认',
    theme_warm: '暖色',
    theme_mono: '黑白极简',
    aria_theme: '页面色调',
    ...
    stat_focus: '研究领域 / 主题',
    stat_location: '常驻',
    stat_location_value: '深圳',
    enhancement_pending: '交互工具加载中。',
    enhancement_error: '交互工具暂时无法加载，研究、论文等独立页面仍可访问。',
    enhancement_reload: '重新加载',
    tools_title: '探索具体工作',
    stat_pubs: '论文',
    tab_about: '概览',
    tab_research: '主题探索',
    ...
    tab_profile: '个人概况',
    about_title: '关于我',
    about_line1: profileData.about.zh,
    about_line2: '我喜欢把几何理解和可靠工程实现结合起来。',
    profile_view_title: '学术履历',
    profile_view_desc: '研究、教育科技与开源实践。',
    research_title: '研究',
    research_static: '研究总览',
    research_intro: '几何理解、视觉智能与 AI 系统。',
    ...
    writing_title: '博客',
    writing_desc: '研究笔记与工程实践。',
    writing_open: '打开博客',
    writing_featured: '精选文章',
    writing_hint: '完整文章会打开静态博客页面，文章语言以源文件为准。',
