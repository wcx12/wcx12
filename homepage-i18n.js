...
export const homepageI18n = {
  en: {
    ...
    selected_project_desc: 'College-major research with traceable sources and evidence gaps.',
    selected_paper: 'Paper',
    selected_paper_desc: 'Visual place recognition with frozen foundation models.',
  ...
  zh: {
    ...
    selected_work: '代表工作',
    selected_project: '项目',
    selected_project_desc: '面向院校专业信息的检索，保留来源与证据缺口。',
    selected_paper: '论文',
    selected_paper_desc: '利用冻结的基础模型进行视觉地点识别。',
    selected_note: '阅读笔记',
